package com.tiagosantos.weatherapp.timeline;
...
public class TimelineView extends View {
    ...
    public static final String TAG = com.tiagosantos.weatherapp.timeline.TimelineView.class.getSimpleName();
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.TimelineView_markerSize, com.tiagosantos.weatherapp.timeline.Utils.dpToPx(20, getContext()));
        ...
        mLineWidth = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineWidth, com.tiagosantos.weatherapp.timeline.Utils.dpToPx(2, getContext()));
        ...
        mLineStyleDashLength = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineStyleDashLength, com.tiagosantos.weatherapp.timeline.Utils.dpToPx(8f, getContext()));
        mLineStyleDashGap = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineStyleDashGap, com.tiagosantos.weatherapp.timeline.Utils.dpToPx(4f, getContext()));
        typedArray.recycle();
